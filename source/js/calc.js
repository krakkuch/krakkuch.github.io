...
let calculator ={
    ...
    let sum = parceInt(calculator.price[0][siteType-1]) + parceInt(calculator.price[1][designType-1]) + parceInt(calculator.price [2][adaptiveType-1]);
    let days = parceInt(calculator.days[0][siteType-1]) + parceInt(calculator.days[1][designType-1]) + parceInt(calculator.days [2][adaptiveType-1]);
    alert("Сроки: "+ days + " Стоимость: "+ sum);
}
}
